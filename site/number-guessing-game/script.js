...
document.querySelector(".check").addEventListener("click", function () {
  ...
  if (!guess) {
    ...
    displayMsg("You have guessed the correct number!");
    ...
    displayMsg("Guess is higher than the secret number!");
    score--;
    document.querySelector(".score").textContent = score;
  } else if (guess < secretNumber && score > 1 && win === false) {
    displayMsg("Guess is lower than the secret number!");
    score--;
    document.querySelector(".score").textContent = score;
  } else {
    displayMsg("Game is over! Press the reset button to play again!");
  }
});
